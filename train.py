...
from dataloaders import RandomNegativeGenerator
from losses import CustomTripletLoss


def train(args):
    chkpt_dir = f'checkpoints/train/{args.runname}/'
    log_dir = f'log/train/{args.runname}/'
    ...
    # Model
    weights_path = cf.path.checkpoint_weights
    if weights_path == '':
        weights_path = None
    ...
    model.compile(
        ...
        loss=CustomTripletLoss(margin=cf.train.margin)
    )
